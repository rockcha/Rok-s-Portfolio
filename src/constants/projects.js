export const PROJECTS = [
  ...
  },
  {
    ...
    detail: {
      ...
      review:
        "5명의 동료와 함께 협업하며 완성한 결과물로서, 백엔드 및 LLM 파트와의 소통을 통해 서비스의 핵심 가치를 극대화하는 API 구조, 데이터 흐름과 UI를 함께 이해하고 논의하며 실제 프로젝트에 적용할 수 있었습니다. 적극적으로 소통한 결과, 다른 분야에 대한 이해뿐만 아니라 협업할 때 필요한 자세와 소통 방식에 대해서도 깊이 있게 생각해보는 계기였다고 생각합니다. VS Code 익스텐션 개발은 특히 처음 경험해보는 영역이었고, 웹과는 다른 실행 환경과 제약 조건을 이해하는 과정이 쉽지 않았습니다. 하지만, 최종적으로 한컴 AI 아카데미 2기 최종 프로젝트에서 최우수 팀으로 선정되면서 가장 재미있는 협업 경험이자 프로젝트 경험으로 남게 되었습니다. ",
    },
  },
  {
    id: 4,
